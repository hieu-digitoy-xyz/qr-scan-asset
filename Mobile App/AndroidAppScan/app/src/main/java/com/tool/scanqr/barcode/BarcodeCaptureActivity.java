 ...
 */
package com.tool.scanqr.barcode;
...
import com.tool.scanqr.ui.ScanQRcodeActivity;
...
//            setResult(CommonStatusCodes.SUCCESS, intent);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(this, "Hết dung lượng",  Toast.LENGTH_LONG).show();
